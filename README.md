...
**ตัวเรียกเกม Fate/Grand Order Arcade ภาษาไทย บนพีซีของคุณเอง**
...
แพตช์นี้แปลตัวเกมเองเป็นภาษาอังกฤษ ทั้งเมนู บทเรียนเริ่มต้น เนื้อเรื่อง หน้าจอต่อสู้ ร้านค้า และหน้าช่วยเหลือ
...
การเริ่มครั้งแรกจะจัดการส่วนที่เหลือให้เองทั้งหมด คือติดตั้งไฟล์ภาษาอังกฤษของเกม ตรวจสอบว่าเกมเขียนลงโฟลเดอร์ของตัวเองได้
...
- **ข้อความในเกม** - แปลเป็นภาษาอังกฤษแล้ว 65,266 บรรทัด ทั้งเนื้อเรื่อง เควสต์ ประวัติเซอร์แวนต์และ Craft Essence
  สกิล ไอเทม ภารกิจ และทุกเมนู ชื่อต่าง ๆ อ้างอิงตามฉบับภาษาอังกฤษ
- **งานภาพในเกม** - คลังสไปรต์ภาษาอังกฤษที่สร้างใหม่ 240 ชุด ทั้งหน้าไตเติล บทเรียนเริ่มต้น เทอร์มินัล การจัดทีม
...
รีลีสหนึ่งชุดคือไฟล์ zip หนึ่งไฟล์ ที่สร้างจากรีโพนี้กับไฟล์เกมภาษาอังกฤษในเครื่องที่ติดตั้งไว้
...
(`FGOLocalPlatform`) ที่ FGOAC scooby สร้างต่อยอดมา และฮุกไฟล์ที่แพตช์นี้ใช้โหลดไฟล์แปลเข้าไป
