...
public partial class App : Application
{
	protected override void OnStartup(StartupEventArgs e)
	{
		...
		{
			MessageBox.Show(ex.Message, "FGOAC scooby - ตรวจสอบเมื่อเริ่มโปรแกรม", MessageBoxButton.OK, MessageBoxImage.Hand);
			Shutdown(4);
			return;
		}
		base.OnStartup(e);
